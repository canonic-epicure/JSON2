StartTest(function(t) {
    ...
    use('JSON2', function () {
        ...
        // XXX implement t.isDeeply
        
//        t.ok(JSON2.parse([]) == '[]', 'Empty array parsed ok')
//        t.ok(JSON2.parse([ 1, 2, 3 ]) == '[1,2,3]', 'Array parsed ok')
//        
//        
//        //======================================================================================================================================================================================================================================================
//        t.diag('Nested array')
//        
//        t.ok(JSON2.parse([ [], [] ]) == '[[],[]]', 'Nested array parsed ok #1')
//        t.ok(JSON2.parse([ [ 1, 2 ], [ 3 ] ]) == '[[1,2],[3]]', 'Nested array parsed ok #2')
//    
//        //======================================================================================================================================================================================================================================================
//        t.diag('Objects')
//        
//        t.ok(JSON2.parse({}) == '{}', 'Empty object parsed ok')
//        t.ok(JSON2.parse({ foo : 'bar', bar : [ 'baz', 'zab' ]}) == '{"foo":"bar","bar":["baz","zab"]}', 'Object parsed ok')
//        
//        t.ok(JSON2.parse({ a : undefined }) == '{}', '"Undefined" entry excluded')
